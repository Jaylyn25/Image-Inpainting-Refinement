...
class PCconv(nn.Module):
    ...
    def forward(self, input, mask):
        ...
        ###
        #x_1 = F.interpolate(input=x_1, size=(32,32), mode='bilinear')
        #x_2 = F.interpolate(input=x_2, size=(32,32), mode='bilinear')
        #x_3 = F.interpolate(input=x_3, size=(32,32), mode='bilinear')
        # print("x_1",x_1[0].size())
        # print("x_2",x_2[0].size())
        # print("x_3",x_3[0].size())
        
        x_4 = self.up(x_4, (int(fineSize1/8), int(fineSize2/8)))
        x_5 = self.up(x_5, (int(fineSize1/8), int(fineSize2/8)))
        x_6 = self.up(x_6, (int(fineSize1/8), int(fineSize2/8)))
        ###
        #x_4 = F.interpolate(input=x_4, size=(23,40), mode='bilinear')
        #x_5 = F.interpolate(input=x_5, size=(23,40), mode='bilinear')
        #x_6 = F.interpolate(input=x_6, size=(23,40), mode='bilinear')
        # print("x_4",x_4[0].size())
        # print("x_5",x_5[0].size())
        # print("x_6",x_6[0].size())
        ...
        ###
        x_1 = self.up_128(x_DE, (int(fineSize1/2), int(fineSize2/2))) + input[0]
        x_2 = self.up_64(x_DE, (int(fineSize1/4), int(fineSize2/4))) + input[1]
        x_3 = self.up_32(x_DE, (int(fineSize1/8), int(fineSize2/8))) + input[2]
        # print("x_1",x_1[0].size())
        # print("x_2",x_2[0].size())
        # print("x_3",x_3[0].size())
        ...
        ###
        #x_4 = F.interpolate(input=x_4, size=(32,40), mode='bilinear')
        #x_5 = F.interpolate(input=x_5, size=(32,40), mode='bilinear')
        #x_6 = F.interpolate(input=x_6, size=(32,40), mode='bilinear')
        # print("x_4",x_4[0].size())
        # print("x_5",x_5[0].size())
        # print("x_6",x_6[0].size())
