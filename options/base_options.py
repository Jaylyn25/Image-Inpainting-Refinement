...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gt_root', type=str, default=r'./data/datasets/gt', help='path to the ground truth')
        #parser.add_argument('--st_root', type=str, default=r'./data/datasets/structure', help='path to structure images')
        parser.add_argument('--synth_root', type=str, default=r'./data/datasets/noise_image', help='path to noise images')
        ...
        parser.add_argument('--name', type=str, default='InpaintingNet',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--fineSize1', type=int, default=256, help='then crop to this size')
        parser.add_argument('--fineSize2', type=int, default=320, help='then crop to this size')
        ...
        #parser.add_argument('--inpainting', action='store_true', help='apply inpainting')
        parser.add_argument('--refinement', action='store_true', help='apply refinement')
    ...
    def parse(self):
        ...
        # set gpu ids
        #opt.gpu_ids = os.environ['CUDA_VISIBLE_DEVICES']
