...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--enhancement', action='store_true', help='use enhancement to increase sharpness')
        parser.add_argument('--sharp_factor', type=float, default=2.0, help='factor of sharpnes')
        self.isTrain = False
